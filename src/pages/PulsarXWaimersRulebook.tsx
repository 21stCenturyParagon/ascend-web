...
const STORAGE_URL = 'https://wdcwyvfeegchjadtyhkh.supabase.co/storage/v1/object/public/public-documents/PulsarXWaimersRulebook.md';

export default function PulsarXWaimersRulebook() {
